...
podTemplate(label: 'jenkins-pipeline', containers: [
    //containerTemplate(name: 'jnlp', image: 'chzbrgr71/jnlp-slave', args: '${computer.jnlpmac} ${computer.name}', workingDir: '/home/jenkins', resourceRequestCpu: '200m', resourceLimitCpu: '200m', resourceRequestMemory: '256Mi', resourceLimitMemory: '256Mi'),
